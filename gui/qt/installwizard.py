...
from electrum_vert import Wallet, Wallet_2of2, Wallet_2of3
import electrum_vert.bitcoin as bitcoin
...
MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of Vertcoin addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def create_cold_seed(self, wallet):
        from electrum_vert.bitcoin import mnemonic_to_seed, bip32_root
