...
from electrum_vert import ELECTRUM_VERSION, print_error
...
class VersionGetter(threading.Thread):
    ...
    def run(self):
        try:
            con = httplib.HTTPConnection('electrum-vert.org', 80, timeout=5)
...
class UpdateLabel(QLabel):
    ...
    def open_website(self):
        webbrowser.open("http://electrum-vert.org/download.html")
        self.dialog.done(0)
