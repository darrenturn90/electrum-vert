...
from electrum_vert.util import print_error
from electrum_vert.bitcoin import is_valid
from electrum_vert import mnemonic, pyqrnative, WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-Vert"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_vert.util import format_satoshis, parse_url
from electrum_vert.network import DEFAULT_SERVERS
from electrum_vert.bitcoin import MIN_RELAY_TX_FEE
...
def run_network_dialog( network, parent ):
    ...
    add_help_button(host_box, 'The name, port number and protocol of your Electrum server, separated by a colon. Example: "electrum.vertpay.com:50004:s". Some servers allow you to connect through http (port 80) or https (port 443)')
    host_box.show()
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-Vert ' + self.wallet.electrum_version + '  -  ' + self.config.path
