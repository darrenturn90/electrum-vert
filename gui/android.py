...
from electrum_vert import SimpleConfig, Wallet, WalletStorage, format_satoshis, mnemonic_encode, mnemonic_decode
...
def pay_to(recipient, amount, fee, label):
    ...
    droid.dialogCreateSpinnerProgress("Electrum-Vert", "signing transaction...")
    droid.dialogShow()
        ...
        if event["name"]=="click":
            ...
            if out == 'contacts':
                ...
                if receive_addr:
                    ...
                    if amount:
                        receive_addr = 'vertcoin:%s?amount=%s'%(receive_addr, amount)
        ...
        if event["name"] == "click":
            ...
            if id=="buttonPay":
                ...
                if not is_valid(recipient):
                    modal_dialog('Error','Invalid Vertcoin address')
                    continue
...
class ElectrumGui:
    ...
    def restore_wallet(self):
        ...
        droid.dialogCreateSpinnerProgress("Electrum-Vert", msg)
        droid.dialogShow()
