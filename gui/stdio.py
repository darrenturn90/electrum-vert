...
_ = lambda x:x
#from i18n import _
from electrum_vert import mnemonic_encode, WalletStorage, Wallet
from electrum_vert.util import format_satoshis, set_verbosity
from electrum_vert.bitcoin import is_valid
from electrum_vert.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-vert create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-vert setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-vert setconfig' to change your settings")
        return True
